...
//     load_lib_backtrace();
//     register_native_object();
//     let js = JSTemplate::new("test_js_string.js".to_string(), "console.log(\"!!!!!!string: \" + \"你好!!!!!!\".length); var view = TextEncoder.encode(\"你好!!!!!!\"); console.log(\"!!!!!!view: \" + view); var r = NativeObject.call(0xffffffff, [view]); console.log(\"!!!!!!r: \" + r); console.log(\"!!!!!!string: \" + TextDecoder.decode(view));".to_string());
//     assert!(js.is_some());
//     let js = js.unwrap();
...
//     load_lib_backtrace();
//     register_native_object();
//     let js = JSTemplate::new("native_object_call_block_reply_test.js".to_string(), "var obj = {}; console.log(\"!!!!!!obj: \" + obj); var r = NativeObject.call(0xffffffff, [true, 0.999, \"你好\"]); console.log(\"!!!!!!r: \" + r); function call(x, y, z) { r = NativeObject.call(0xffffffff, [x, y, z]); console.log(\"!!!!!!r: \" + r); };".to_string());
//     assert!(js.is_some());
//     let js = js.unwrap();
